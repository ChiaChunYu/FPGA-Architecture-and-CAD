...
$$Cost = HPWL \times (Congestion Coefficient)$$
...
* Region-Based Moves: Calculating the average of all incident nets' bounding box centers to determine an "ideal" target point, then sampling a new site within a range-limited search window around that center to focus on local refinements as the temperature drops.
